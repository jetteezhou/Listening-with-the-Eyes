...
> 📄 **详细文档**：关于任务定义、指令类型和数据标注格式的详细说明，请阅读 [任务说明文档 (assets/task_info_zh.md)](assets/task_info_zh.md)。
...
.
├── assets/                      # 静态资源与详细文档
│   ├── task_info_en.md         # 任务定义与标注详情 (英文版)
│   └── task_info_zh.md         # 任务定义与标注详情 (中文版)
...
> **指标说明**：
> *   **Eco-Accuracy (eco)**：当且仅当 "What"（意图）、"Where"（空间定位）和 "When"（时间对齐）全部正确时，该样本才判定为正确。
> *   **L1-L4**：代表任务的复杂程度级别。
